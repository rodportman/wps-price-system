...
const generatePDF = async () => {
  try {
    ...
    const options = {
      margin: [10, 10, 0, 0], //这个是生成的PDF的A4页面的边距样式，和页面样式不通用
